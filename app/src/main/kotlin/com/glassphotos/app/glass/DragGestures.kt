...
/**
 * Like [androidx.compose.foundation.gestures.detectDragGestures] but fires [onDragStart]
 * on the very first pointer-down (no slop), so press-driven animations feel immediate.
 */
